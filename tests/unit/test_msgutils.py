...
from nonebot_plugin_shitbot.msgutils import msg_foldl, msg_foldr, msg_map, msg_filter, get_multimedias_url, modify_msg_data, DELETE, ORIGIN, DataVariables, DumpedMsg, DumpedSeg
from nonebot_plugin_shitbot.aux import validate_schema
...
inner_content = [
    ...
    },
    {
        "type": "image",
        "data": {
            "url": "https://github.com/Cmd-GZ/nonebot-plugin-shitbot"
        }
    },
    {
        "type": "text",
...
class TestMsgGetUrls:
    def test_get_urls(self):
        assert get_multimedias_url(msg) == ["https://github.com/Cmd-GZ/nonebot-plugin-shitbot", "https://manyacg.top/setu"] * 3
        assert get_multimedias_url(inner_content) == ["https://github.com/Cmd-GZ/nonebot-plugin-shitbot", "https://manyacg.top/setu"]
